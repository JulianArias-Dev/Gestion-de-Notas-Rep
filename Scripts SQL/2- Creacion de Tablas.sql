...
CREATE TABLE PERMISOS(
	...
	CARGO INT NOT NULL,
	MODULO INT NOT NULL,
	CONSTRAINT FK_CARGOPERMISO FOREIGN KEY (CARGO) REFERENCES CARGOS(IDCARGO),
...
ALTER TABLE [JulianHernandoDavid_NotasDB].[dbo].[ESTUDIANTES]
ADD ACUDIENTE INT NOT NULL;

ALTER TABLE [JulianHernandoDavid_NotasDB].[dbo].[ESTUDIANTES]
ADD CONSTRAINT FK_ACUDIENTE_STD FOREIGN KEY (ACUDIENTE) 
REFERENCES [JulianHernandoDavid_NotasDB].[dbo].[ACUDIENTES] (IDACUDIENTE);
